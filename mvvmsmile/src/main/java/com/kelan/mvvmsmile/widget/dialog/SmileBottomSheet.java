...
/**
 * SmileBottomSheet 在 {@link Dialog} 的基础上重新定制了 {@link #show()} 和 {@link #hide()} 时的动画效果, 使 {@link Dialog} 在界面底部升起和降下。
 * <p>
 * 提供了以下两种面板样式:
 * <ul>
 * <li>列表样式, 使用 {@link SmileBottomSheet.BottomListSheetBuilder} 生成。</li>
 * <li>宫格类型, 使用 {@link SmileBottomSheet.BottomGridSheetBuilder} 生成。</li>
 * </ul>
 * </p>
 */
public class SmileBottomSheet extends Dialog {
    private static final String TAG = "SmileBottomSheet";
    ...
    public SmileBottomSheet(Context context) {
        super(context, R.style.SmileUI_BottomSheet);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int screenWidth = SmileDisplayHelper.getScreenWidth(getContext());
        int screenHeight = SmileDisplayHelper.getScreenHeight(getContext());
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                mContentView.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            SmileBottomSheet.super.dismiss();
                        } catch (Exception e) {
                            //SmileLog.w(TAG, "dismiss error\n" + Log.getStackTraceString(e));
                        }
                    }
                });
            }
    ...
    /**
     * 生成列表类型的 {@link SmileBottomSheet} 对话框。
     */
    public static class BottomListSheetBuilder {

        private Context mContext;

        private SmileBottomSheet mDialog;
        ...
        public SmileBottomSheet build() {
            mDialog = new SmileBottomSheet(mContext);
        ...
        private boolean needToScroll() {
            int itemHeight = SmileResHelper.getAttrDimen(mContext, R.attr.smile_bottom_sheet_list_item_height);
            ...
            if (mTitleTv != null && !SmileLangHelper.isNullOrEmpty(mTitle)) {
                totalHeight += SmileResHelper.getAttrDimen(mContext, R.attr.smile_bottom_sheet_title_height);
            }
        ...
        protected int getListMaxHeight() {
            return (int) (SmileDisplayHelper.getScreenHeight(mContext) * 0.5);
        }
        ...
        protected int getContentViewLayoutId() {
            return R.layout.smile_bottom_sheet_list;
        }

        public interface OnSheetItemClickListener {
            void onClick(SmileBottomSheet dialog, View itemView, int position, String tag);
        }
        ...
        private class ListAdapter extends BaseAdapter {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    convertView = inflater.inflate(R.layout.smile_bottom_sheet_list_item, parent, false);
    ...
    /**
     * 生成宫格类型的 {@link SmileBottomSheet} 对话框。
     */
    public static class BottomGridSheetBuilder implements View.OnClickListener {
        ...
        public BottomGridSheetBuilder addItem(int imageRes, CharSequence text, Object tag, @Style int style, int subscriptRes) {
            SmileBottomSheetItemView itemView = createItemView(AppCompatResources.getDrawable(mContext, imageRes), text, tag, subscriptRes);
        ...
        public SmileBottomSheetItemView createItemView(Drawable drawable, CharSequence text, Object tag, int subscriptRes) {
            LayoutInflater inflater = LayoutInflater.from(mContext);
            SmileBottomSheetItemView itemView = (SmileBottomSheetItemView) inflater.inflate(getItemViewLayoutId(), null, false);
        ...
        private View buildViews() {
            ...
            int screenWidth = SmileDisplayHelper.getScreenWidth(mContext);
            int screenHeight = SmileDisplayHelper.getScreenHeight(mContext);
        ...
        protected int getContentViewLayoutId() {
            return R.layout.smile_bottom_sheet_grid;
        }

        protected int getItemViewLayoutId() {
            return R.layout.smile_bottom_sheet_grid_item;
        }
        ...
        private int calculateItemWidth(int width, int maxItemCountInEachLine, int paddingLeft, int paddingRight) {
            if (mMiniItemWidth == -1) {
                mMiniItemWidth = SmileResHelper.getAttrDimen(mContext, R.attr.smile_bottom_sheet_grid_item_mini_width);
            }
        ...
        public interface OnSheetItemClickListener {
            void onClick(SmileBottomSheet dialog, View itemView);
        }
