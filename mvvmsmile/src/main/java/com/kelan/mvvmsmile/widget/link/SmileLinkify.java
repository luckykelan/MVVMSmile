package com.kelan.mvvmsmile.widget.link;
...
public class SmileLinkify {
    ...
    public static final WebUrlMatcher Smile_WEB_URL_MATCHER = new WebUrlMatcher() {
        @Override
    ...
    public static void useQmuiWebUrlMatcher(){
        sWebUrlMatcher = Smile_WEB_URL_MATCHER;
    }
     ...
     */
    public static boolean addLinks(Spannable text, int mask, ColorStateList linkColor, ColorStateList bgColor, SmileOnSpanClickListener l) {
        if (mask == 0) {
            return false;
        }
     ...
     * LinkMovementMethod.
     */
    public static boolean addLinks(TextView text, int mask, ColorStateList linkColor, ColorStateList bgColor, SmileOnSpanClickListener l) {
        if (mask == 0) {
            return false;
        }
    ...
    private static void applyLink(String url, int start, int end, Spannable text, final ColorStateList linkColor, final ColorStateList bgColor, SmileOnSpanClickListener l) {
    ...
    private static abstract class StyleableURLSpan extends URLSpan implements ITouchableSpan {
        ...
        protected SmileOnSpanClickListener mOnSpanClickListener;

        public StyleableURLSpan(String url, SmileOnSpanClickListener l) {
            super(url);
            mUrl = url;
