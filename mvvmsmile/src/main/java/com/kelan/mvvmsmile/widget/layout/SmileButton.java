...
import com.kelan.mvvmsmile.widget.alpha.SmileAlphaButton;
...
public class SmileButton extends SmileAlphaButton implements ISmileLayout {
    ...
    public SmileButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public SmileButton(Context context, AttributeSet attrs, int defStyleAttr) {
