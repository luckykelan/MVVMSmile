...
public class SmileTabIcon extends Drawable {
    ...
    public SmileTabIcon(@NonNull Drawable normalIconDrawable, @Nullable Drawable selectedIconDrawable) {
    ...
    /**
     * set the select faction for SmileTabIcon, value must be in [0, 1]
     *
    ...
    public void setSelectFraction(float fraction, int color) {
        ...
        if (mSelectedIconDrawable == null) {
            SmileDrawableHelper.setDrawableTintColor(mNormalIconDrawable, color);
        } else {
