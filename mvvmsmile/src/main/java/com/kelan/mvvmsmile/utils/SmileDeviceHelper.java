...
public class SmileDeviceHelper {
    private final static String TAG = "SmileDeviceHelper";
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            try {
                ...
                //SmileLog.printErrStackTrace(TAG, e, "read file error");
            } finally {
                SmileLangHelper.close(fileInputStream);
            }
        }
        ...
        try {
            ...
            //SmileLog.printErrStackTrace(TAG, e, "read SystemProperties error");
        }
    }
