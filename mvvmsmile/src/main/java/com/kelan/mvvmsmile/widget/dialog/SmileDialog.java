...
/**
 * SmileDialog 对话框一般由 {@link SmileDialogBuilder} 及其子类创建, 不同的 Builder 可以创建不同类型的对话框,
 * 例如消息类型的对话框、菜单项对话框等等。
 *
 * @author cginechen
 * @date 2015-10-20
 * @see SmileDialogBuilder
 */
public class SmileDialog extends Dialog {
    ...
    public SmileDialog(Context context) {
        this(context, R.style.SmileUI_Dialog);
    }

    public SmileDialog(Context context, int styleRes) {
     ...
     */
    public static class MessageDialogBuilder extends SmileDialogBuilder<MessageDialogBuilder> {
        protected CharSequence mMessage;
        private SmileWrapContentScrollView mScrollContainer;
        private SmileSpanTouchFixTextView mTextView;
        ...
        protected void onCreateContent(SmileDialog dialog, ViewGroup parent, Context context) {
            if (mMessage != null && mMessage.length() != 0) {
                mTextView = new SmileSpanTouchFixTextView(context);
                assignMessageTvWithAttr(mTextView, hasTitle(), R.attr.smile_dialog_message_content_style);
                mTextView.setText(mMessage);
                mTextView.setMovementMethodDefault();


                mScrollContainer = new SmileWrapContentScrollView(context);
     ...
     */
    public static class CheckBoxMessageDialogBuilder extends SmileDialogBuilder<CheckBoxMessageDialogBuilder> {
        ...
        public CheckBoxMessageDialogBuilder(Context context) {
            super(context);
            mCheckMarkDrawable = SmileResHelper.getAttrDrawable(context, R.attr.smile_s_checkbox);
        }
        ...
        protected void onCreateContent(SmileDialog dialog, ViewGroup parent, Context context) {
            if (mMessage != null && mMessage.length() != 0) {
                ...
                mTextView = new SmileSpanTouchFixTextView(context);
                mTextView.setMovementMethodDefault();
                MessageDialogBuilder.assignMessageTvWithAttr(mTextView, hasTitle(), R.attr.smile_dialog_message_content_style);
     ...
     * 带输入框的对话框 Builder
     */
    public static class EditTextDialogBuilder extends SmileDialogBuilder<EditTextDialogBuilder> {
        ...
        protected void onCreateContent(SmileDialog dialog, ViewGroup parent, Context context) {
            ...
            MessageDialogBuilder.assignMessageTvWithAttr(mEditText, hasTitle(), R.attr.smile_dialog_edit_content_style);
            mEditText.setFocusable(true);
            mEditText.setFocusableInTouchMode(true);
            mEditText.setImeOptions(EditorInfo.IME_ACTION_GO);
            mEditText.setId(R.id.smile_dialog_edit_input);

            if (!SmileLangHelper.isNullOrEmpty(mDefaultText)) {
                mEditText.setText(mDefaultText);
            }

            mRightImageView = new ImageView(context);
            mRightImageView.setId(R.id.smile_dialog_edit_right_icon);
            ...
            mMainLayout.setBackgroundResource(R.drawable.smile_edittext_bg_border_bottom);
            ...
            mEditText.setPadding(0, 0, 0, SmileDisplayHelper.dpToPx(5));
        ...
        protected RelativeLayout.LayoutParams createRightIconLayoutParams() {
            ...
            rightIconLp.leftMargin = SmileDisplayHelper.dpToPx(5);
            return rightIconLp;
        }
    ...
    public static class MenuBaseDialogBuilder<T extends SmileDialogBuilder> extends SmileDialogBuilder<T> {
        protected ArrayList<ItemViewFactory> mMenuItemViewsFactoryList;
        protected LinearLayout mMenuItemContainer;
        protected SmileWrapContentScrollView mContentScrollView;
        protected LinearLayout.LayoutParams mMenuItemLp;
        protected ArrayList<SmileDialogMenuItemView> mMenuItemViews = new ArrayList<>();
        ...
        @Deprecated
        public T addItem(final SmileDialogMenuItemView itemView, final OnClickListener listener) {
            itemView.setMenuIndex(mMenuItemViewsFactoryList.size());
            itemView.setListener(new SmileDialogMenuItemView.MenuItemViewListener() {
                @Override
            ...
            mMenuItemViewsFactoryList.add(new ItemViewFactory() {
                @Override
                public SmileDialogMenuItemView createItemView(Context context) {
                    return itemView;
                }
            });
            return (T) this;
        ...
        public T addItem(final ItemViewFactory itemViewFactory, final OnClickListener listener) {
            mMenuItemViewsFactoryList.add(new ItemViewFactory() {
                @Override
                public SmileDialogMenuItemView createItemView(Context context) {
                    SmileDialogMenuItemView itemView = itemViewFactory.createItemView(context);
        ...
        protected void onCreateContent(SmileDialog dialog, ViewGroup parent, Context context) {
            ...
            TypedArray a = context.obtainStyledAttributes(null, R.styleable.SmileDialogMenuContainerStyleDef, R.attr.smile_dialog_menu_container_style, 0);
            int count = a.getIndexCount();
            int paddingTop = 0, paddingBottom = 0, paddingVerWhenSingle = 0,
                    paddingTopWhenTitle = 0, paddingBottomWhenAction = 0, itemHeight = -1;
            for (int i = 0; i < count; i++) {
                int attr = a.getIndex(i);
                if (attr == R.styleable.SmileDialogMenuContainerStyleDef_android_paddingTop) {
                    paddingTop = a.getDimensionPixelSize(attr, paddingTop);
                } else if (attr == R.styleable.SmileDialogMenuContainerStyleDef_android_paddingBottom) {
                    paddingBottom = a.getDimensionPixelSize(attr, paddingBottom);
                } else if (attr == R.styleable.SmileDialogMenuContainerStyleDef_smile_dialog_menu_container_single_padding_vertical) {
                    paddingVerWhenSingle = a.getDimensionPixelSize(attr, paddingVerWhenSingle);
                } else if (attr == R.styleable.SmileDialogMenuContainerStyleDef_smile_dialog_menu_container_padding_top_when_title_exist) {
                    paddingTopWhenTitle = a.getDimensionPixelSize(attr, paddingTopWhenTitle);
                } else if (attr == R.styleable.SmileDialogMenuContainerStyleDef_smile_dialog_menu_container_padding_bottom_when_action_exist) {
                    paddingBottomWhenAction = a.getDimensionPixelSize(attr, paddingBottomWhenAction);
                } else if (attr == R.styleable.SmileDialogMenuContainerStyleDef_smile_dialog_menu_item_height) {
            ...
            for (ItemViewFactory factory : mMenuItemViewsFactoryList) {
                SmileDialogMenuItemView itemView = factory.createItemView(context);
                mMenuItemContainer.addView(itemView, mMenuItemLp);
                mMenuItemViews.add(itemView);
            }


            mContentScrollView = new SmileWrapContentScrollView(context);
        ...
        public interface ItemViewFactory {
            SmileDialogMenuItemView createItemView(Context context);
        }
    }
    ...
    public static class MenuDialogBuilder extends MenuBaseDialogBuilder<MenuDialogBuilder> {
        ...
        public MenuDialogBuilder addItem(final CharSequence item, OnClickListener listener) {
            addItem(new ItemViewFactory() {
                @Override
                public SmileDialogMenuItemView createItemView(Context context) {
                    return new SmileDialogMenuItemView.TextItemView(context, item);
                }
            }, listener);
            return this;
        }
    ...
    public static class CheckableDialogBuilder extends MenuBaseDialogBuilder<CheckableDialogBuilder> {
        ...
        protected void onItemClick(int index) {
            for (int i = 0; i < mMenuItemViews.size(); i++) {
                SmileDialogMenuItemView itemView = mMenuItemViews.get(i);
                if (i == index) {
        ...
        public CheckableDialogBuilder addItems(CharSequence[] items, OnClickListener listener) {
            for (final CharSequence item : items) {
                addItem(new ItemViewFactory() {
                    @Override
                    public SmileDialogMenuItemView createItemView(Context context) {
                        return new SmileDialogMenuItemView.MarkItemView(context, item);
                    }
                }, listener);
            }
            return this;
    ...
    public static class MultiCheckableDialogBuilder extends MenuBaseDialogBuilder<MultiCheckableDialogBuilder> {
        ...
        public MultiCheckableDialogBuilder addItems(CharSequence[] items, OnClickListener listener) {
            for (final CharSequence item : items) {
                addItem(new ItemViewFactory() {
                    @Override
                    public SmileDialogMenuItemView createItemView(Context context) {
                        return new SmileDialogMenuItemView.CheckItemView(context, true, item);
                    }
                }, listener);
            }
            return this;
        ...
        @Override
        public MultiCheckableDialogBuilder addItem(SmileDialogMenuItemView itemView, OnClickListener listener) {
        ...
        @Override
        protected void onItemClick(int index) {
            SmileDialogMenuItemView itemView = mMenuItemViews.get(index);
     ...
     * 自定义对话框内容区域的 Builder
     */
    public static class CustomDialogBuilder extends SmileDialogBuilder {
     ...
     */
    public static abstract class AutoResizeDialogBuilder extends SmileDialogBuilder {
        ...
        public abstract View onBuildContent(SmileDialog dialog, ScrollView parent);
        ...
        private void bindEvent(final Context context) {
            ...
            mRootView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                public void onGlobalLayout() {
                    ...
                    mScreenHeight = SmileDisplayHelper.getScreenHeight(context);
