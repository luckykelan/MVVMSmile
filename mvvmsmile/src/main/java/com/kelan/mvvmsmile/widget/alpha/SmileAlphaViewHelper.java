...
public class SmileAlphaViewHelper {
    ...
    public SmileAlphaViewHelper(@NonNull View target) {
        mTarget = new WeakReference<>(target);
        mPressedAlpha = SmileResHelper.getAttrFloatValue(target.getContext(), R.attr.smile_alpha_pressed);
        mDisabledAlpha = SmileResHelper.getAttrFloatValue(target.getContext(), R.attr.smile_alpha_disabled);
    }

    public SmileAlphaViewHelper(@NonNull View target, float pressedAlpha, float disabledAlpha) {
        mTarget = new WeakReference<>(target);
