 ...
 * @date 2015-08-25
 */
public class SmileObservableScrollView extends ScrollView {

    private int mScrollOffset = 0;

    private List<OnScrollChangedListener> mOnScrollChangedListeners;

    public SmileObservableScrollView(Context context) {
        super(context);
    }

    public SmileObservableScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SmileObservableScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnScrollChangedListener {
        void onScrollChanged(SmileObservableScrollView scrollView, int l, int t, int oldl, int oldt);
    }
