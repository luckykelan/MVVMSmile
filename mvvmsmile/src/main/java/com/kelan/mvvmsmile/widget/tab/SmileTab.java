...
public class SmileTab {
    ...
    public SmileTabIcon getTabIcon() {
        return tabIcon;
    }
    ...
    public int getNormalTabIconWidth() {
        if (normalTabIconWidth == SmileTabIcon.TAB_ICON_INTRINSIC && tabIcon != null) {
    ...
    public int getNormalTabIconHeight() {
        if (normalTabIconHeight == SmileTabIcon.TAB_ICON_INTRINSIC && tabIcon != null) {
            return tabIcon.getIntrinsicWidth();
        }
