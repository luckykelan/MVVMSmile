package com.kelan.mvvmsmile.widget;
...
/**
 * Created by wanghua on 19-3-26.
 * Description：
 */
public class SmileStatusView {
    public static final int STATUS_LOADING = 1;
    public static final int STATUS_LOAD_SUCCESS = 2;
    public static final int STATUS_LOAD_FAILED = 3;
    public static final int STATUS_EMPTY_DATA = 4;

    private static volatile SmileStatusView mDefault;
     ...
     * @return Gloading
     */
    public static SmileStatusView from(Adapter adapter) {
        SmileStatusView smileStatusView = new SmileStatusView();
        smileStatusView.mAdapter = adapter;
        return smileStatusView;
    }
     ...
     */
    public static SmileStatusView getDefault() {
        if (mDefault == null) {
            synchronized (SmileStatusView.class) {
                if (mDefault == null) {
                    mDefault = new SmileStatusView();
                }
            }
        }
        return mDefault;
    ...
    /**
     * Gloading holder<br>
     * create by {@link SmileStatusView#wrap(Activity)} or {@link SmileStatusView#wrap(View)}<br>
