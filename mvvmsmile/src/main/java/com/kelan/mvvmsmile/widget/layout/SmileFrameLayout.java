...
import com.kelan.mvvmsmile.widget.alpha.SmileAlphaFrameLayout;

import androidx.annotation.ColorInt;



public class SmileFrameLayout extends SmileAlphaFrameLayout implements ISmileLayout {
    private SmileLayoutHelper mLayoutHelper;

    public SmileFrameLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public SmileFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public SmileFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new SmileLayoutHelper(context, attrs, 0, this);
    ...
    @Override
    public void setRadiusAndShadow(int radius, @SmileLayoutHelper.HideRadiusSide int hideRadiusSide, int shadowElevation, final float shadowAlpha) {
    ...
    @Override
    public void setRadius(int radius, @SmileLayoutHelper.HideRadiusSide int hideRadiusSide) {
