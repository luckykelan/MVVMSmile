...
import com.kelan.mvvmsmile.utils.SmileDrawableHelper;

public class SmileTabIndicator {
    ...
    /**
     * is indicator layout in top of SmileTabSegment?
     */
    ...
    public SmileTabIndicator(int indicatorHeight, boolean indicatorTop,
    ...
    public SmileTabIndicator(@NonNull Drawable drawable, boolean indicatorTop,
                            boolean isIndicatorWidthFollowContent) {
    ...
    protected void updateInfo(int left, int width, int color) {
        ...
        if (mIndicatorDrawable != null) {
            SmileDrawableHelper.setDrawableTintColor(mIndicatorDrawable, color);
        } else {
