...
import com.kelan.mvvmsmile.widget.layout.ISmileLayout;
import com.kelan.mvvmsmile.widget.layout.SmileFrameLayout;
 ...
 * <p>
 */
public class SmilePopup extends SmileBasePopup {
    ...
    public SmilePopup(Context context) {
        this(context, DIRECTION_NONE);
    }

    public SmilePopup(Context context, @Direction int preferredDirection) {
        super(context);
    ...
    private void setAnimationStyle(int screenWidth, int requestedX) {
        ...
        switch (mAnimStyle) {
            case ANIM_GROW_FROM_LEFT:
                mWindow.setAnimationStyle(onTop ? R.style.SmileUI_Animation_PopUpMenu_Left : R.style.SmileUI_Animation_PopDownMenu_Left);
                break;

            case ANIM_GROW_FROM_RIGHT:
                mWindow.setAnimationStyle(onTop ? R.style.SmileUI_Animation_PopUpMenu_Right : R.style.SmileUI_Animation_PopDownMenu_Right);
                break;

            case ANIM_GROW_FROM_CENTER:
                mWindow.setAnimationStyle(onTop ? R.style.SmileUI_Animation_PopUpMenu_Center : R.style.SmileUI_Animation_PopDownMenu_Center);
                break;
            case ANIM_AUTO:
    ...
    public void setContentView(View root) {
        if (root.getBackground() != null) {
            if (root instanceof ISmileLayout) {
                ((ISmileLayout) root).setRadius(getRootLayoutRadius(mContext));
            } else {
                SmileFrameLayout clipLayout = new SmileFrameLayout(mContext);
    ...
    protected int getRootLayoutRadius(Context context) {
        return SmileDisplayHelper.dp2px(context, 5);
    }
