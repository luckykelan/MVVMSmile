...
public class RSAHelper {
    ...
    public String decryptWithBase64(String base64String) {
        ...
        try {
            binaryData = decrypt(getPrivateKey(), Base64.decode(base64String.getBytes(), Base64.DEFAULT));
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public String encryptWithBase64(String string) {
        byte[] binaryData = new byte[0];
        try {
            binaryData = encrypt(getPublicKey(), string.getBytes());
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public byte[] encrypt(RSAPublicKey publicKey, byte[] plainTextData) throws Exception {
        ...
        try {
            ...
            byte[] output = cipherDoFinal(cipher, plainTextData, enSegmentSize);
            return output;
        } catch (NoSuchAlgorithmException e) {
    ...
    public byte[] decrypt(RSAPrivateKey privateKey, byte[] cipherData) throws Exception {
        ...
        try {
            ...
            byte[] output = cipherDoFinal(cipher, cipherData,deSegmentSize);
            return output;
        } catch (NoSuchAlgorithmException e) {
