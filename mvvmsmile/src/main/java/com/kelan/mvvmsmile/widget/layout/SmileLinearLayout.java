...
public class SmileLinearLayout extends SmileAlphaLinearLayout implements ISmileLayout {
    private SmileLayoutHelper mLayoutHelper;

    public SmileLinearLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public SmileLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public SmileLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new SmileLayoutHelper(context, attrs, defStyleAttr, this);
