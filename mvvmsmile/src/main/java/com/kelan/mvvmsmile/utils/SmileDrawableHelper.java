 ...
 * @date 2016-03-17
 */
public class SmileDrawableHelper {
    private static final String TAG = SmileDrawableHelper.class.getSimpleName();
    ...
    public static Bitmap createBitmapFromView(View view, int leftCrop, int topCrop, int rightCrop, int bottomCrop) {
        Bitmap originBitmap = SmileDrawableHelper.createBitmapFromView(view);
