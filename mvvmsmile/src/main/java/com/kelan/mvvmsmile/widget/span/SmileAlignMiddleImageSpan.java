 ...
 * @date 2016-03-17
 */
public class SmileAlignMiddleImageSpan extends ImageSpan {
     ...
     */
    public SmileAlignMiddleImageSpan(Drawable d, int verticalAlignment) {
     ...
     */
    public SmileAlignMiddleImageSpan(Drawable d, int verticalAlignment, float fontWidthMultiple) {
