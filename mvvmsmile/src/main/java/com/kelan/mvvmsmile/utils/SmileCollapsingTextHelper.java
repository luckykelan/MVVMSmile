...
public final class SmileCollapsingTextHelper {
    ...
    public SmileCollapsingTextHelper(View view){
        this(view, 0f);
    }

    public SmileCollapsingTextHelper(View view, float defaultExpanededFraction) {
        mView = view;
    ...
    public void setCollapsedTextAppearance(int resId) {
        TypedArray a = mView.getContext().obtainStyledAttributes(resId, R.styleable.SmileTextAppearance);
        if (a.hasValue(R.styleable.SmileTextAppearance_android_textColor)) {
            mCollapsedTextColor = a.getColorStateList(R.styleable.SmileTextAppearance_android_textColor);
        }
        if (a.hasValue(R.styleable.SmileTextAppearance_android_textSize)) {
            mCollapsedTextSize = a.getDimensionPixelSize(R.styleable.SmileTextAppearance_android_textSize,
                    (int) mCollapsedTextSize);
        }
        mCollapsedShadowColor = a.getInt(R.styleable.SmileTextAppearance_android_shadowColor, 0);
        mCollapsedShadowDx = a.getFloat(R.styleable.SmileTextAppearance_android_shadowDx, 0);
        mCollapsedShadowDy = a.getFloat(R.styleable.SmileTextAppearance_android_shadowDy, 0);
        mCollapsedShadowRadius = a.getFloat(R.styleable.SmileTextAppearance_android_shadowRadius, 0);
        a.recycle();
    ...
    public void setExpandedTextAppearance(int resId) {
        TypedArray a = mView.getContext().obtainStyledAttributes(resId, R.styleable.SmileTextAppearance);
        if (a.hasValue(R.styleable.SmileTextAppearance_android_textColor)) {
            mExpandedTextColor = a.getColorStateList(R.styleable.SmileTextAppearance_android_textColor);
        }
        if (a.hasValue(R.styleable.SmileTextAppearance_android_textSize)) {
            mExpandedTextSize = a.getDimensionPixelSize(R.styleable.SmileTextAppearance_android_textSize,
                    (int) mExpandedTextSize);
        }
        mExpandedShadowColor = a.getInt(
                R.styleable.SmileTextAppearance_android_shadowColor, 0);
        mExpandedShadowDx = a.getFloat(
                R.styleable.SmileTextAppearance_android_shadowDx, 0);
        mExpandedShadowDy = a.getFloat(
                R.styleable.SmileTextAppearance_android_shadowDy, 0);
        mExpandedShadowRadius = a.getFloat(
                R.styleable.SmileTextAppearance_android_shadowRadius, 0);
        a.recycle();
    ...
    private void calculateOffsets(final float fraction) {
        ...
        if (mCollapsedTextColor != mExpandedTextColor) {
            ...
            // fraction
            mTextPaint.setColor(SmileColorHelper.computeColor(
        ...
        mTextPaint.setShadowLayer(
                ...
                SmileColorHelper.computeColor(mExpandedShadowColor, mCollapsedShadowColor, fraction));
