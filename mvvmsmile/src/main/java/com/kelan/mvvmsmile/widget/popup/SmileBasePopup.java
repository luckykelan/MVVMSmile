 ...
 */
public abstract class SmileBasePopup {
    private static final String TAG = "SmileBasePopup";
     ...
     */
    public SmileBasePopup(Context context) {
        mContext = context;
    ...
    protected int makeWidthMeasureSpec(View view) {
        return View.MeasureSpec.makeMeasureSpec(SmileDisplayHelper.getScreenWidth(mContext), View.MeasureSpec.AT_MOST);
    }

    protected int makeHeightMeasureSpec(View view) {
        return View.MeasureSpec.makeMeasureSpec(SmileDisplayHelper.getScreenHeight(mContext), View.MeasureSpec.AT_MOST);
    }
    ...
    public class RootView extends SmileFrameLayout {
        ...
        protected void onConfigurationChanged(Configuration newConfig) {
            ...
            SmileBasePopup.this.onConfigurationChanged(newConfig);
        }
